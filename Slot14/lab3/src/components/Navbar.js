...
const Navbar = ({search, setSearch, onOpenProfileModal}) => (
  <nav style={{
    display: 'flex',
    ...
    <div style={{display: 'flex', gap: '2rem', alignItems: 'center'}}>
      ...
      <a href="#" style={{color: '#fdfdfdff', textDecoration: 'none', fontWeight: 'bold'}} onClick={onOpenProfileModal}>Build your Profile</a>
    </div>
